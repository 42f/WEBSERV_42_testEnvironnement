...
docker run --rm -d -it -p 42:22 -p17000:17000 -p 80:80 -p 8080:8080 -p443:443 -i --mount type=bind,src=$VOLUME,dst=/tmp/volume --mount type=bind,src=$SUPERVISOR,dst=/tmp/supervisor bv/nginx_webserv
